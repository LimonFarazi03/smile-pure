        ...
        <div className='mb-3'>
          <div className="row">
            <div className="col-sm-4 mb-5">
              ...
              <img width={'100%'} src={image1} class="card-img-top" alt="..."></img>
                <div className="card-body">
                  ...
                  Cosmetic dentistry mainly concerns improving the appearance of your teeth, including whitening & …
                  </p>
                  <div className="btn-more mx-auto">More Details</div>
                </div>
              </div>
            </div>
            <div className="col-sm-4">
              <div className="card">
              <img width={'100%'} src={image2} class="card-img-top" alt="..."></img>
                <div className="card-body">
            ...
            <div className="col-sm-4 cursor-pointer">
              <div className="card">
              <img width={'100%'} src={image3} class="card-img-top" alt="..."></img>
                <div className="card-body">
